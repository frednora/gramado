// abnt2_keymap.c
// Complete ABNT2 keyboard mapping for Gramado OS
...
unsigned char map_abnt2[ABNT2_CHARMAP_SIZE] = {
    ...
    VK_PRINTSCREEN, '.', '\\',
    VK_F11, VK_F12, '/', VK_F14,
    VK_LWIN, VK_RWIN, VK_APPS, VK_F18, VK_F19,

    // 0x60–0x6F
    '`', VK_LCONTROL, '/', VK_F23, VK_ALTGR,
    'b','f', VK_ARROW_UP, 'p',
    VK_ARROW_LEFT, VK_ARROW_RIGHT, 's',
    VK_ARROW_DOWN, 'n', VK_INSERT, 'r',

    // 0x70–0x7F
    VK_F1, VK_F2, VK_F3, '/', VK_F5, VK_F6, VK_F7, VK_PAUSEBREAK,
    VK_F9, VK_F10, VK_F11, VK_F12, VK_F13, VK_F14,
...
unsigned char ctl_abnt2[ABNT2_CHARMAP_SIZE] = {
    ...
    VK_RSHIFT, '*', VK_ALTGR, ASCII_NUL, // Ctrl+Space
    VK_CAPSLOCK, VK_F1, VK_F2, VK_F3, VK_F4, VK_F5,
...
// Used when AltGr is active

unsigned char altgr_abnt2[ABNT2_CHARMAP_SIZE] = {
    0,0,'¹','²','³','£','¢','¬','{','}','§','[',']','\\','|',
    VK_TAB,
