...
// Created for Gramado / Fred Nora style kernels.
// Supports runtime resolution change via Bochs DISPI interface.

#ifndef __QEMUDISP_QEMUDISP_H
#define __QEMUDISP_QEMUDISP_H    1

//
// QEMU / Bochs Graphics constants
//
...
// Low-level helpers (optional for advanced use)
